...
## [v0.1.5](https://github.com/runapi-ai/gemini-omni-mcp/releases/tag/v0.1.5) - 2026-07-08

### Changed
- Publish MCP login onboarding, optional API key metadata, and the updated core dependency.

## [v0.1.4](https://github.com/runapi-ai/gemini-omni-mcp/releases/tag/v0.1.4) - 2026-06-24
...
## [v0.1.3](https://github.com/runapi-ai/gemini-omni-mcp/releases/tag/v0.1.3) - 2026-06-24

### Changed
- Refresh public README metadata for the focused Gemini Omni MCP package.

### Fixed
- Correct the GitHub repository badge URL so package README badges render cleanly on npm and GitHub.

## [v0.1.2](https://github.com/runapi-ai/gemini-omni-mcp/releases/tag/v0.1.2) - 2026-06-24
...
## [v0.1.1](https://github.com/runapi-ai/gemini-omni-mcp/releases/tag/v0.1.1) - 2026-06-24

### Changed
- Distinct per-line README, npm keywords/description, and GitHub topics for Gemini Omni so the package is discoverable on its own name and capabilities. No tool, schema, or behavior changes.

## [v0.1.0](https://github.com/runapi-ai/gemini-omni-mcp/releases/tag/v0.1.0) - 2026-06-24

### Added
- Initial release of the Gemini Omni MCP server: create tasks, poll their status, and check pricing for every Gemini Omni model with a single RunAPI API key.
